...
//Creating a function so it can be called rather than start right when the browser opens.
  ...
  function randNumGuitars() {
    numGuitars = Math.floor((Math.random() * 20) + 1); //Creating a random answer for # of guitars.
  ...
  function formatStatesFunction(){
    ...
    return statesVisitedFormat;
  }
  formatStatesFunction();
